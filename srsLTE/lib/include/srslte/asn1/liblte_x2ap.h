...
#define LIBLTE_X2AP_MAXNOOFE_RABS                                      256
#define LIBLTE_X2AP_MAXNOOFTACS                                        256
#define LIBLTE_X2AP_MAXNOOFBPLMNS                                      6
#define LIBLTE_X2AP_MAXNOOFEPLMNS                                      15
#define LIBLTE_X2AP_MAXNOOFFORBLACS                                    4096
#define LIBLTE_X2AP_MAXNOOFINDIVIDUALS1CONNECTIONSTORESET              256
#define LIBLTE_X2AP_MAXNOOFTAIFORWARNING                               65535
#define LIBLTE_X2AP_MAXNOOFEMERGENCYAREAID                             65535
#define LIBLTE_X2AP_MAXNOOFCELLINEAI                                   65535
#define LIBLTE_X2AP_MAXNOOFENBX2EXTTLAS                                16
#define LIBLTE_X2AP_MAXNOOFRATS                                        8
#define LIBLTE_X2AP_MAXNOOFMMECS                                       256
#define LIBLTE_X2AP_MAXNOOFTAFORMDT                                    8
#define LIBLTE_X2AP_MAXNOOFCELLSFORRESTART                             256
#define LIBLTE_X2AP_MAXNOOFRESTARTEMERGENCYAREAIDS                     256
#define LIBLTE_X2AP_MAXNOOFCSGS                                        256
#define LIBLTE_X2AP_MAXNOOFERRORS                                      256
#define LIBLTE_X2AP_MAXNOOFEPLMNSPLUSONE                               16
#define LIBLTE_X2AP_MAXNOOFCELLS                                       16
#define LIBLTE_X2AP_MAXNOOFCELLINTAI                                   65535
#define LIBLTE_X2AP_MAXNOOFENBX2GTPTLAS                                16
#define LIBLTE_X2AP_MAXNOOFCELLIDFORMDT                                32
#define LIBLTE_X2AP_MAXNOOFRESTARTTAIS                                 2048
#define LIBLTE_X2AP_MAXPROTOCOLEXTENSIONS                              65535
#define LIBLTE_X2AP_MAXNOOFPLMNSPERMME                                 32
#define LIBLTE_X2AP_MAXNOOFCELLID                                      65535
#define LIBLTE_X2AP_MAXNOOFGROUPIDS                                    65535
#define LIBLTE_X2AP_MAXNOOFTAIS                                        256
#define LIBLTE_X2AP_MAXNOOFENBX2TLAS                                   2
...
typedef enum{
  ...
  LIBLTE_X2AP_PROC_ID_HANDOVERRESOURCEALLOCATION                      = 1,
  LIBLTE_X2AP_PROC_ID_HANDOVERNOTIFICATION                            = 2,
  LIBLTE_X2AP_PROC_ID_PATHSWITCHREQUEST                               = 3,
  LIBLTE_X2AP_PROC_ID_HANDOVERCANCEL                                  = 4,
  LIBLTE_X2AP_PROC_ID_E_RABSETUP                                      = 5,
  LIBLTE_X2AP_PROC_ID_E_RABMODIFY                                     = 6,
  LIBLTE_X2AP_PROC_ID_E_RABRELEASE                                    = 7,
  LIBLTE_X2AP_PROC_ID_E_RABRELEASEINDICATION                          = 8,
  LIBLTE_X2AP_PROC_ID_INITIALCONTEXTSETUP                             = 9,
  LIBLTE_X2AP_PROC_ID_PAGING                                          = 10,
  LIBLTE_X2AP_PROC_ID_DOWNLINKNASTRANSPORT                            = 11,
  LIBLTE_X2AP_PROC_ID_INITIALUEMESSAGE                                = 12,
  LIBLTE_X2AP_PROC_ID_UPLINKNASTRANSPORT                              = 13,
  LIBLTE_X2AP_PROC_ID_RESET                                           = 14,
  LIBLTE_X2AP_PROC_ID_ERRORINDICATION                                 = 15,
  LIBLTE_X2AP_PROC_ID_NASNONDELIVERYINDICATION                        = 16,
  LIBLTE_X2AP_PROC_ID_S1SETUP                                         = 17,
  LIBLTE_X2AP_PROC_ID_UECONTEXTRELEASEREQUEST                         = 18,
  LIBLTE_X2AP_PROC_ID_DOWNLINKS1CDMA2000TUNNELING                     = 19,
  LIBLTE_X2AP_PROC_ID_UPLINKS1CDMA2000TUNNELING                       = 20,
  LIBLTE_X2AP_PROC_ID_UECONTEXTMODIFICATION                           = 21,
  LIBLTE_X2AP_PROC_ID_UECAPABILITYINFOINDICATION                      = 22,
  LIBLTE_X2AP_PROC_ID_UECONTEXTRELEASE                                = 23,
  LIBLTE_X2AP_PROC_ID_ENBSTATUSTRANSFER                               = 24,
  LIBLTE_X2AP_PROC_ID_MMESTATUSTRANSFER                               = 25,
  LIBLTE_X2AP_PROC_ID_DEACTIVATETRACE                                 = 26,
  LIBLTE_X2AP_PROC_ID_TRACESTART                                      = 27,
  LIBLTE_X2AP_PROC_ID_TRACEFAILUREINDICATION                          = 28,
  LIBLTE_X2AP_PROC_ID_ENBCONFIGURATIONUPDATE                          = 29,
  LIBLTE_X2AP_PROC_ID_MMECONFIGURATIONUPDATE                          = 30,
  LIBLTE_X2AP_PROC_ID_LOCATIONREPORTINGCONTROL                        = 31,
  LIBLTE_X2AP_PROC_ID_LOCATIONREPORTINGFAILUREINDICATION              = 32,
  LIBLTE_X2AP_PROC_ID_LOCATIONREPORT                                  = 33,
  LIBLTE_X2AP_PROC_ID_OVERLOADSTART                                   = 34,
  LIBLTE_X2AP_PROC_ID_OVERLOADSTOP                                    = 35,
  LIBLTE_X2AP_PROC_ID_WRITEREPLACEWARNING                             = 36,
  LIBLTE_X2AP_PROC_ID_ENBDIRECTINFORMATIONTRANSFER                    = 37,
  LIBLTE_X2AP_PROC_ID_MMEDIRECTINFORMATIONTRANSFER                    = 38,
  LIBLTE_X2AP_PROC_ID_PRIVATEMESSAGE                                  = 39,
  LIBLTE_X2AP_PROC_ID_ENBCONFIGURATIONTRANSFER                        = 40,
  LIBLTE_X2AP_PROC_ID_MMECONFIGURATIONTRANSFER                        = 41,
  LIBLTE_X2AP_PROC_ID_CELLTRAFFICTRACE                                = 42,
  LIBLTE_X2AP_PROC_ID_KILL                                            = 43,
  LIBLTE_X2AP_PROC_ID_DOWNLINKUEASSOCIATEDLPPATRANSPORT               = 44,
  LIBLTE_X2AP_PROC_ID_UPLINKUEASSOCIATEDLPPATRANSPORT                 = 45,
  LIBLTE_X2AP_PROC_ID_DOWNLINKNONUEASSOCIATEDLPPATRANSPORT            = 46,
  LIBLTE_X2AP_PROC_ID_UPLINKNONUEASSOCIATEDLPPATRANSPORT              = 47,
  LIBLTE_X2AP_PROC_ID_UERADIOCAPABILITYMATCH                          = 48,
  LIBLTE_X2AP_PROC_ID_PWSRESTARTINDICATION                            = 49,
...
********************************************************************************/
typedef enum{
  LIBLTE_X2AP_IE_ID_MME_UE_X2AP_ID                                  = 0,
  LIBLTE_X2AP_IE_ID_HANDOVERTYPE                                    = 1,
  LIBLTE_X2AP_IE_ID_CAUSE                                           = 2,
  LIBLTE_X2AP_IE_ID_SOURCEID                                        = 3,
  LIBLTE_X2AP_IE_ID_TARGETID                                        = 4,
  LIBLTE_X2AP_IE_ID_SPARE5                                          = 5,
  LIBLTE_X2AP_IE_ID_SPARE6                                          = 6,
  LIBLTE_X2AP_IE_ID_SPARE7                                          = 7,
  LIBLTE_X2AP_IE_ID_ENB_UE_X2AP_ID                                  = 8,
  LIBLTE_X2AP_IE_ID_SPARE9                                          = 9,
  LIBLTE_X2AP_IE_ID_SPARE10                                         = 10,
  LIBLTE_X2AP_IE_ID_SPARE11                                         = 11,
  LIBLTE_X2AP_IE_ID_E_RABSUBJECTTODATAFORWARDINGLIST                = 12,
  LIBLTE_X2AP_IE_ID_E_RABTORELEASELISTHOCMD                         = 13,
  LIBLTE_X2AP_IE_ID_E_RABDATAFORWARDINGITEM                         = 14,
  LIBLTE_X2AP_IE_ID_E_RABRELEASEITEMBEARERRELCOMP                   = 15,
  LIBLTE_X2AP_IE_ID_E_RABTOBESETUPLISTBEARERSUREQ                   = 16,
  LIBLTE_X2AP_IE_ID_E_RABTOBESETUPITEMBEARERSUREQ                   = 17,
  LIBLTE_X2AP_IE_ID_E_RABADMITTEDLIST                               = 18,
  LIBLTE_X2AP_IE_ID_E_RABFAILEDTOSETUPLISTHOREQACK                  = 19,
  LIBLTE_X2AP_IE_ID_E_RABADMITTEDITEM                               = 20,
  LIBLTE_X2AP_IE_ID_E_RABFAILEDTOSETUPITEMHOREQACK                  = 21,
  LIBLTE_X2AP_IE_ID_E_RABTOBESWITCHEDDLLIST                         = 22,
  LIBLTE_X2AP_IE_ID_E_RABTOBESWITCHEDDLITEM                         = 23,
  LIBLTE_X2AP_IE_ID_E_RABTOBESETUPLISTCTXTSUREQ                     = 24,
  LIBLTE_X2AP_IE_ID_TRACEACTIVATION                                 = 25,
  LIBLTE_X2AP_IE_ID_NAS_PDU                                         = 26,
  LIBLTE_X2AP_IE_ID_E_RABTOBESETUPITEMHOREQ                         = 27,
  LIBLTE_X2AP_IE_ID_E_RABSETUPLISTBEARERSURES                       = 28,
  LIBLTE_X2AP_IE_ID_E_RABFAILEDTOSETUPLISTBEARERSURES               = 29,
  LIBLTE_X2AP_IE_ID_E_RABTOBEMODIFIEDLISTBEARERMODREQ               = 30,
  LIBLTE_X2AP_IE_ID_E_RABMODIFYLISTBEARERMODRES                     = 31,
  LIBLTE_X2AP_IE_ID_E_RABFAILEDTOMODIFYLIST                         = 32,
  LIBLTE_X2AP_IE_ID_E_RABTOBERELEASEDLIST                           = 33,
  LIBLTE_X2AP_IE_ID_E_RABFAILEDTORELEASELIST                        = 34,
  LIBLTE_X2AP_IE_ID_E_RABITEM                                       = 35,
  LIBLTE_X2AP_IE_ID_E_RABTOBEMODIFIEDITEMBEARERMODREQ               = 36,
  LIBLTE_X2AP_IE_ID_E_RABMODIFYITEMBEARERMODRES                     = 37,
  LIBLTE_X2AP_IE_ID_E_RABRELEASEITEM                                = 38,
  LIBLTE_X2AP_IE_ID_E_RABSETUPITEMBEARERSURES                       = 39,
  LIBLTE_X2AP_IE_ID_SECURITYCONTEXT                                 = 40,
  LIBLTE_X2AP_IE_ID_HANDOVERRESTRICTIONLIST                         = 41,
  LIBLTE_X2AP_IE_ID_SPARE42                                         = 42,
  LIBLTE_X2AP_IE_ID_UEPAGINGID                                      = 43,
  LIBLTE_X2AP_IE_ID_PAGINGDRX                                       = 44,
  LIBLTE_X2AP_IE_ID_SPARE45                                         = 45,
  LIBLTE_X2AP_IE_ID_TAILIST                                         = 46,
  LIBLTE_X2AP_IE_ID_TAIITEM                                         = 47,
  LIBLTE_X2AP_IE_ID_E_RABFAILEDTOSETUPLISTCTXTSURES                 = 48,
  LIBLTE_X2AP_IE_ID_E_RABRELEASEITEMHOCMD                           = 49,
  LIBLTE_X2AP_IE_ID_E_RABSETUPITEMCTXTSURES                         = 50,
  LIBLTE_X2AP_IE_ID_E_RABSETUPLISTCTXTSURES                         = 51,
  LIBLTE_X2AP_IE_ID_E_RABTOBESETUPITEMCTXTSUREQ                     = 52,
  LIBLTE_X2AP_IE_ID_E_RABTOBESETUPLISTHOREQ                         = 53,
  LIBLTE_X2AP_IE_ID_SPARE54                                         = 54,
  LIBLTE_X2AP_IE_ID_GERANTOLTEHOINFORMATIONRES                      = 55,
  LIBLTE_X2AP_IE_ID_SPARE56                                         = 56,
  LIBLTE_X2AP_IE_ID_UTRANTOLTEHOINFORMATIONRES                      = 57,
  LIBLTE_X2AP_IE_ID_CRITICALITYDIAGNOSTICS                          = 58,
  LIBLTE_X2AP_IE_ID_GLOBAL_ENB_ID                                   = 59,
  LIBLTE_X2AP_IE_ID_ENBNAME                                         = 60,
  LIBLTE_X2AP_IE_ID_MMENAME                                         = 61,
  LIBLTE_X2AP_IE_ID_SPARE62                                         = 62,
  LIBLTE_X2AP_IE_ID_SERVEDPLMNS                                     = 63,
  LIBLTE_X2AP_IE_ID_SUPPORTEDTAS                                    = 64,
  LIBLTE_X2AP_IE_ID_TIMETOWAIT                                      = 65,
  LIBLTE_X2AP_IE_ID_UEAGGREGATEMAXIMUMBITRATE                       = 66,
  LIBLTE_X2AP_IE_ID_TAI                                             = 67,
  LIBLTE_X2AP_IE_ID_SPARE68                                         = 68,
  LIBLTE_X2AP_IE_ID_E_RABRELEASELISTBEARERRELCOMP                   = 69,
  LIBLTE_X2AP_IE_ID_CDMA2000PDU                                     = 70,
  LIBLTE_X2AP_IE_ID_CDMA2000RATTYPE                                 = 71,
  LIBLTE_X2AP_IE_ID_CDMA2000SECTORID                                = 72,
  LIBLTE_X2AP_IE_ID_SECURITYKEY                                     = 73,
  LIBLTE_X2AP_IE_ID_UERADIOCAPABILITY                               = 74,
  LIBLTE_X2AP_IE_ID_GUMMEI_ID                                       = 75,
  LIBLTE_X2AP_IE_ID_SPARE76                                         = 76,
  LIBLTE_X2AP_IE_ID_SPARE77                                         = 77,
  LIBLTE_X2AP_IE_ID_E_RABINFORMATIONLISTITEM                        = 78,
  LIBLTE_X2AP_IE_ID_DIRECT_FORWARDING_PATH_AVAILABILITY             = 79,
  LIBLTE_X2AP_IE_ID_UEIDENTITYINDEXVALUE                            = 80,
  LIBLTE_X2AP_IE_ID_SPARE81                                         = 81,
  LIBLTE_X2AP_IE_ID_SPARE82                                         = 82,
  LIBLTE_X2AP_IE_ID_CDMA2000HOSTATUS                                = 83,
  LIBLTE_X2AP_IE_ID_CDMA2000HOREQUIREDINDICATION                    = 84,
  LIBLTE_X2AP_IE_ID_SPARE85                                         = 85,
  LIBLTE_X2AP_IE_ID_E_UTRAN_TRACE_ID                                = 86,
  LIBLTE_X2AP_IE_ID_RELATIVEMMECAPACITY                             = 87,
  LIBLTE_X2AP_IE_ID_SOURCEMME_UE_X2AP_ID                            = 88,
  LIBLTE_X2AP_IE_ID_BEARERS_SUBJECTTOSTATUSTRANSFER_ITEM            = 89,
  LIBLTE_X2AP_IE_ID_ENB_STATUSTRANSFER_TRANSPARENTCONTAINER         = 90,
  LIBLTE_X2AP_IE_ID_UE_ASSOCIATEDLOGICALS1_CONNECTIONITEM           = 91,
  LIBLTE_X2AP_IE_ID_RESETTYPE                                       = 92,
  LIBLTE_X2AP_IE_ID_UE_ASSOCIATEDLOGICALS1_CONNECTIONLISTRESACK     = 93,
  LIBLTE_X2AP_IE_ID_E_RABTOBESWITCHEDULITEM                         = 94,
  LIBLTE_X2AP_IE_ID_E_RABTOBESWITCHEDULLIST                         = 95,
  LIBLTE_X2AP_IE_ID_S_TMSI                                          = 96,
  LIBLTE_X2AP_IE_ID_CDMA2000ONEXRAND                                = 97,
  LIBLTE_X2AP_IE_ID_REQUESTTYPE                                     = 98,
  LIBLTE_X2AP_IE_ID_UE_X2AP_IDS                                     = 99,
  LIBLTE_X2AP_IE_ID_EUTRAN_CGI                                      = 100,
  LIBLTE_X2AP_IE_ID_OVERLOADRESPONSE                                = 101,
  LIBLTE_X2AP_IE_ID_CDMA2000ONEXSRVCCINFO                           = 102,
  LIBLTE_X2AP_IE_ID_E_RABFAILEDTOBERELEASEDLIST                     = 103,
  LIBLTE_X2AP_IE_ID_SOURCE_TOTARGET_TRANSPARENTCONTAINER            = 104,
  LIBLTE_X2AP_IE_ID_SERVEDGUMMEIS                                   = 105,
  LIBLTE_X2AP_IE_ID_SUBSCRIBERPROFILEIDFORRFP                       = 106,
  LIBLTE_X2AP_IE_ID_UESECURITYCAPABILITIES                          = 107,
  LIBLTE_X2AP_IE_ID_CSFALLBACKINDICATOR                             = 108,
  LIBLTE_X2AP_IE_ID_CNDOMAIN                                        = 109,
  LIBLTE_X2AP_IE_ID_E_RABRELEASEDLIST                               = 110,
  LIBLTE_X2AP_IE_ID_MESSAGEIDENTIFIER                               = 111,
  LIBLTE_X2AP_IE_ID_SERIALNUMBER                                    = 112,
  LIBLTE_X2AP_IE_ID_WARNINGAREALIST                                 = 113,
  LIBLTE_X2AP_IE_ID_REPETITIONPERIOD                                = 114,
  LIBLTE_X2AP_IE_ID_NUMBEROFBROADCASTREQUEST                        = 115,
  LIBLTE_X2AP_IE_ID_WARNINGTYPE                                     = 116,
  LIBLTE_X2AP_IE_ID_WARNINGSECURITYINFO                             = 117,
  LIBLTE_X2AP_IE_ID_DATACODINGSCHEME                                = 118,
  LIBLTE_X2AP_IE_ID_WARNINGMESSAGECONTENTS                          = 119,
  LIBLTE_X2AP_IE_ID_BROADCASTCOMPLETEDAREALIST                      = 120,
  LIBLTE_X2AP_IE_ID_INTER_SYSTEMINFORMATIONTRANSFERTYPEEDT          = 121,
  LIBLTE_X2AP_IE_ID_INTER_SYSTEMINFORMATIONTRANSFERTYPEMDT          = 122,
  LIBLTE_X2AP_IE_ID_TARGET_TOSOURCE_TRANSPARENTCONTAINER            = 123,
  LIBLTE_X2AP_IE_ID_SRVCCOPERATIONPOSSIBLE                          = 124,
  LIBLTE_X2AP_IE_ID_SRVCCHOINDICATION                               = 125,
  LIBLTE_X2AP_IE_ID_NAS_DOWNLINKCOUNT                               = 126,
  LIBLTE_X2AP_IE_ID_CSG_ID                                          = 127,
  LIBLTE_X2AP_IE_ID_CSG_IDLIST                                      = 128,
  LIBLTE_X2AP_IE_ID_SONCONFIGURATIONTRANSFERECT                     = 129,
  LIBLTE_X2AP_IE_ID_SONCONFIGURATIONTRANSFERMCT                     = 130,
  LIBLTE_X2AP_IE_ID_TRACECOLLECTIONENTITYIPADDRESS                  = 131,
  LIBLTE_X2AP_IE_ID_MSCLASSMARK2                                    = 132,
  LIBLTE_X2AP_IE_ID_MSCLASSMARK3                                    = 133,
  LIBLTE_X2AP_IE_ID_RRC_ESTABLISHMENT_CAUSE                         = 134,
  LIBLTE_X2AP_IE_ID_NASSECURITYPARAMETERSFROME_UTRAN                = 135,
  LIBLTE_X2AP_IE_ID_NASSECURITYPARAMETERSTOE_UTRAN                  = 136,
  LIBLTE_X2AP_IE_ID_DEFAULTPAGINGDRX                                = 137,
  LIBLTE_X2AP_IE_ID_SOURCE_TOTARGET_TRANSPARENTCONTAINER_SECONDARY  = 138,
  LIBLTE_X2AP_IE_ID_TARGET_TOSOURCE_TRANSPARENTCONTAINER_SECONDARY  = 139,
  LIBLTE_X2AP_IE_ID_EUTRANROUNDTRIPDELAYESTIMATIONINFO              = 140,
  LIBLTE_X2AP_IE_ID_BROADCASTCANCELLEDAREALIST                      = 141,
  LIBLTE_X2AP_IE_ID_CONCURRENTWARNINGMESSAGEINDICATOR               = 142,
  LIBLTE_X2AP_IE_ID_DATA_FORWARDING_NOT_POSSIBLE                    = 143,
  LIBLTE_X2AP_IE_ID_EXTENDEDREPETITIONPERIOD                        = 144,
  LIBLTE_X2AP_IE_ID_CELLACCESSMODE                                  = 145,
  LIBLTE_X2AP_IE_ID_CSGMEMBERSHIPSTATUS                             = 146,
  LIBLTE_X2AP_IE_ID_LPPA_PDU                                        = 147,
  LIBLTE_X2AP_IE_ID_ROUTING_ID                                      = 148,
  LIBLTE_X2AP_IE_ID_TIME_SYNCHRONIZATION_INFO                       = 149,
  LIBLTE_X2AP_IE_ID_PS_SERVICENOTAVAILABLE                          = 150,
  LIBLTE_X2AP_IE_ID_PAGINGPRIORITY                                  = 151,
  LIBLTE_X2AP_IE_ID_X2TNLCONFIGURATIONINFO                          = 152,
  LIBLTE_X2AP_IE_ID_ENBX2EXTENDEDTRANSPORTLAYERADDRESSES            = 153,
  LIBLTE_X2AP_IE_ID_GUMMEILIST                                      = 154,
  LIBLTE_X2AP_IE_ID_GW_TRANSPORTLAYERADDRESS                        = 155,
  LIBLTE_X2AP_IE_ID_CORRELATION_ID                                  = 156,
  LIBLTE_X2AP_IE_ID_SOURCEMME_GUMMEI                                = 157,
  LIBLTE_X2AP_IE_ID_MME_UE_X2AP_ID_2                                = 158,
  LIBLTE_X2AP_IE_ID_REGISTEREDLAI                                   = 159,
  LIBLTE_X2AP_IE_ID_RELAYNODE_INDICATOR                             = 160,
  LIBLTE_X2AP_IE_ID_TRAFFICLOADREDUCTIONINDICATION                  = 161,
  LIBLTE_X2AP_IE_ID_MDTCONFIGURATION                                = 162,
  LIBLTE_X2AP_IE_ID_MMERELAYSUPPORTINDICATOR                        = 163,
  LIBLTE_X2AP_IE_ID_GWCONTEXTRELEASEINDICATION                      = 164,
  LIBLTE_X2AP_IE_ID_MANAGEMENTBASEDMDTALLOWED                       = 165,
  LIBLTE_X2AP_IE_ID_PRIVACYINDICATOR                                = 166,
  LIBLTE_X2AP_IE_ID_TIME_UE_STAYEDINCELL_ENHANCEDGRANULARITY        = 167,
  LIBLTE_X2AP_IE_ID_HO_CAUSE                                        = 168,
  LIBLTE_X2AP_IE_ID_VOICESUPPORTMATCHINDICATOR                      = 169,
  LIBLTE_X2AP_IE_ID_GUMMEITYPE                                      = 170,
  LIBLTE_X2AP_IE_ID_M3CONFIGURATION                                 = 171,
  LIBLTE_X2AP_IE_ID_M4CONFIGURATION                                 = 172,
  LIBLTE_X2AP_IE_ID_M5CONFIGURATION                                 = 173,
  LIBLTE_X2AP_IE_ID_MDT_LOCATION_INFO                               = 174,
  LIBLTE_X2AP_IE_ID_MOBILITYINFORMATION                             = 175,
  LIBLTE_X2AP_IE_ID_TUNNEL_INFORMATION_FOR_BBF                      = 176,
  LIBLTE_X2AP_IE_ID_MANAGEMENTBASEDMDTPLMNLIST                      = 177,
  LIBLTE_X2AP_IE_ID_SIGNALLINGBASEDMDTPLMNLIST                      = 178,
  LIBLTE_X2AP_IE_ID_ULCOUNTVALUEEXTENDED                            = 179,
  LIBLTE_X2AP_IE_ID_DLCOUNTVALUEEXTENDED                            = 180,
  LIBLTE_X2AP_IE_ID_RECEIVESTATUSOFULPDCPSDUSEXTENDED               = 181,
  LIBLTE_X2AP_IE_ID_ECGILISTFORRESTART                              = 182,
  LIBLTE_X2AP_IE_ID_SIPTO_CORRELATION_ID                            = 183,
  LIBLTE_X2AP_IE_ID_SIPTO_L_GW_TRANSPORTLAYERADDRESS                = 184,
  LIBLTE_X2AP_IE_ID_TRANSPORTINFORMATION                            = 185,
  LIBLTE_X2AP_IE_ID_LHN_ID                                          = 186,
  LIBLTE_X2AP_IE_ID_ADDITIONALCSFALLBACKINDICATOR                   = 187,
  LIBLTE_X2AP_IE_ID_TAILISTFORRESTART                               = 188,
  LIBLTE_X2AP_IE_ID_USERLOCATIONINFORMATION                         = 189,
  LIBLTE_X2AP_IE_ID_EMERGENCYAREAIDLISTFORRESTART                   = 190,
  LIBLTE_X2AP_IE_ID_KILLALLWARNINGMESSAGES                          = 191,
...
/* Reference: https://github.com/boundary/wireshark/tree/master/asn1/x2ap/X2AP-CommonDataTypes.asn */
